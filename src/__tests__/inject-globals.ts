...
class TrafficLayer extends MVCObject implements google.maps.TrafficLayer {
  constructor() {
    super();
  }
  getMap = jest.fn().mockImplementation(() => 'map');
  setMap = jest.fn().mockImplementation(() => null);
  setOptions = jest.fn().mockImplementation(() => null);
}

global.google.maps.TrafficLayer = TrafficLayer;
